...
public class ModuleInfoContainer extends ModuleInfo {
    ...
    public static List<ModuleInfoContainer> getModules() {
        ...
        otherContainer.add(
                ...
                new ModuleInfo(FuckedLightButtonModule.class, FuckedLightButtonModule.TITLE_RESOURCE, FuckedLightButtonModule.ICON_RESOURCE),
                new ModuleInfo(TemperatureModule.class, TemperatureModule.TITLE_RESOURCE, TemperatureModule.ICON_RESOURCE)
        );
