 ...
 */
public class ClockModule extends AbstractDisplayModule implements MainThreadReceiver<GlobalSlowUpdateEvent> {
    ...
    public void onEventMainThread(GlobalSlowUpdateEvent event) {
        Log.d(ClockModule.class.getSimpleName(), "event caught: " + event.getClass().getSimpleName());
