...
public class ThemeSwitchModule extends AbstractDisplayModule {
    ...
    public ThemeSwitchModule( ColorResource bgColorResource, ColorResource fgColorResource) {
        super( ModuleEnum.SETTINGS_THEME, TITLE_RESOURCE, ICON_RESOURCE, bgColorResource, fgColorResource, UNIT_RESOURCE );
    }

    public ThemeSwitchModule( ) {
        super( ModuleEnum.SETTINGS_THEME, TITLE_RESOURCE, ICON_RESOURCE, UNIT_RESOURCE );
    }
