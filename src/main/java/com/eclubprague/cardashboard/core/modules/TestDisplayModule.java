...
public class TestDisplayModule extends AbstractDisplayModule {
    ...
    public TestDisplayModule(IModule parent, StringResource titleResource, IconResource iconResource, ColorResource bgColorResource, ColorResource fgColorResource, StringResource unitResource) {
        super(parent, titleResource, iconResource, bgColorResource, fgColorResource, unitResource);
//        task = new UpdateTask();
//        task.execute();
    }
